      ...
      <div className="grid">
        <section className="card">
          ...
          <div style={{ display: 'flex', gap: 12, marginTop: 20 }}>
            <a className="btn" href="https://t.me" target="_blank" rel="noopener noreferrer">
        ...
        <aside className="card">
          ...
          <p style={{ opacity: 0.6, marginTop: 8 }}>
            Дальше добавим Stripe/бота/формы и страницы.
          </p>
        </aside>
      </div>

      <footer style={{ opacity: 0.7, marginTop: 32, textAlign: 'center' }}>
        PM BY MADI • Сделано с ❤️
      </footer>
    </main>
  );
}
